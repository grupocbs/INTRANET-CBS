<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RRHH_SOLICITUD_RECLUTAMIENTO.aspx.cs"
    MasterPageFile="~/Site.master" Inherits="RRHH_SOLICITUD_RECLUTAMIENTO" MaintainScrollPositionOnPostback="true" %>
        ...
        <ContentTemplate>
            <div>
                <dx:ASPxFormLayout runat="server" ID="formLayout" CssClass="formLayout" SettingsItems-HorizontalAlign="Center"
                    ...
                    <Items>
                        <dx:LayoutGroup Caption="Reclutamientos - Formulario de Solicitud" GroupBoxDecoration="HeadingLine"
                        ...
                        <dx:LayoutGroup Caption="" GroupBoxDecoration="box">
                            <Items>
                                ...
                                <dx:LayoutItem Caption="Fecha de Solicitud">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxDateEdit ID="txt_fecha_solicitud" Enabled="false" runat="server" UseMaskBehavior="true"
                                                MinDate="01/01/1900" Width="120px" EditFormatString="dd/MM/yyyy" DisplayFormatString="dd/MM/yyyy">
                                ...
                                <dx:LayoutItem Caption="Razon Social">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxComboBox ID="cmb_razon_social" runat="server" Width="300px" HelpText="Seleccione la Razón Social a la que se vinculará la Solicitud"
                                                HelpTextSettings-DisplayMode="Popup">
                                            </dx:ASPxComboBox>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
                                <dx:LayoutItem Caption="Solicitudes a Generar">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxTextBox ID="txt_a_generar" runat="server" Width="120px" Text="1" HelpText="Cantidad de Solicitudes a Generar. Cada una representara un Ingreso."
                                                HelpTextSettings-DisplayMode="Popup">
                                                <ValidationSettings EnableCustomValidation="True" ErrorDisplayMode="Text" ErrorTextPosition="Bottom"
                                                    SetFocusOnError="true">
                                                    <ErrorFrameStyle Font-Size="Smaller" />
                                                ...
                                                <MaskSettings Mask="<1..50>" />
                                            </dx:ASPxTextBox>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
                                <dx:LayoutItem Caption="Solicitudes a Generar (Confirmar)">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxTextBox ID="txt_confirmar_a_generar" runat="server" Width="120px" Text="1"
                                                HelpText="Confirme Cantidad de Solicitudes a Generar" HelpTextSettings-DisplayMode="Popup">
                                                <ValidationSettings EnableCustomValidation="True" ErrorDisplayMode="Text" ErrorTextPosition="Bottom"
                                                    SetFocusOnError="true">
                                                    <ErrorFrameStyle Font-Size="Smaller" />
                                                    <RequiredField IsRequired="True" ErrorText="Requerido" />
