...
public partial class RRHH_SOLICITUD_ALTA_REPORTE_TODOS : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sql = "select *,ESTADO=CASE WHEN PENDIENTE=1 THEN 'PENDIENTE' ELSE 'FINALIZADA' END  from RRHH_SOLICITUD_INGRESO with (nolock) order by id desc";
