<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RRHH_NORMATIVAS_CARGA.aspx.cs"
    MasterPageFile="~/Site.master" Inherits="RRHH_NORMATIVAS_CARGA" Culture="es-AR"
    UICulture="es-AR" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <dx:ASPxFormLayout runat="server" ID="formLayout" CssClass="formLayout" SettingsItems-HorizontalAlign="Center"
        ...
        <Items>
            <dx:LayoutGroup Caption="Carga Normativas" GroupBoxDecoration="HeadingLine" ColCount="1"
            ...
            <dx:LayoutGroup Caption="" GroupBoxDecoration="box">
                <Items>
                    ...
                    <dx:LayoutItem Caption="TIPO">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer>
                                <dx:ASPxComboBox ID="cmb_tipo" runat="server" Width="300px" AutoPostBack="true" OnSelectedIndexChanged="cmb_tipo_SelectedIndexChanged">
                                </dx:ASPxComboBox>
                            </dx:LayoutItemNestedControlContainer>
                        </LayoutItemNestedControlCollection>
                    </dx:LayoutItem>
                        ...
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer>
                                <dx:ASPxFileManager ID="fileManager" runat="server" OnFolderCreating="fileManager_FolderCreating"
                                    ...
                                    <Settings RootFolder="~/Archivos/NORMATIVAS" ThumbnailFolder="~/Content/FileManager/Thumbnails"
