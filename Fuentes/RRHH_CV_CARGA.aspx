<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RRHH_CV_CARGA.aspx.cs" Inherits="RRHH_CV_CARGA" MaintainScrollPositionOnPostback="true"  %>
                            ...
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <div id="externalDropZone" class="dropZoneExternal">
                                        <div id="dragZone">
                                            <span class="dragZoneText">Arrastre una foto aqui</span>
                                        </div>
