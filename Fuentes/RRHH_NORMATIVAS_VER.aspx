<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RRHH_NORMATIVAS_VER.aspx.cs"
    MasterPageFile="~/Site.master" Inherits="RRHH_NORMATIVAS_VER" Culture="es-AR"
    UICulture="es-AR" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <dx:ASPxFormLayout runat="server" ID="formLayout" CssClass="formLayout" SettingsItems-HorizontalAlign="Center"
        ...
        <Items>
            <dx:LayoutGroup Caption="Ver Normativas" GroupBoxDecoration="HeadingLine" ColCount="1"
