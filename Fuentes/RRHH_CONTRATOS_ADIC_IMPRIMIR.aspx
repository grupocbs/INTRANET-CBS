<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RRHH_CONTRATOS_ADIC_IMPRIMIR.aspx.cs"
    MaintainScrollPositionOnPostback="true" Inherits="RRHH_CONTRATOS_ADIC_IMPRIMIR"
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <dx:ASPxFormLayout runat="server" ID="formLayout" CssClass="formLayout" SettingsItems-HorizontalAlign="Center"
                ...
                <Items>
                    <dx:LayoutGroup Caption="Informacion Adicional de Contratos" GroupBoxDecoration="HeadingLine"
                                ...
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <table align="left">
                                            <tr>
                                                <td>
                                                    <dx:ASPxButton ID="btn_imprimir" runat="server" Text="Imprimir" OnClick="btn_imprimir_Click"
                                                        Width="100px">
                                                    </dx:ASPxButton>
                                                </td>
                                            </tr>
