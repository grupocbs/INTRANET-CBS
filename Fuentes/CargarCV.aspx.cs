...
public partial class CargarCV : System.Web.UI.Page
{
    ...
    protected void btn_enviar_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (rbtl_postulacion.SelectedIndex > -1)
            {
                ...
                if (b == "0")
                {
                    ...
                    {
                        error = "Error:No se pudo subir la foto";
                    ...
                    {
                        error = "Error:No se pudo subir el archivo del CV";
                    ...
                    error = "Error:No se pudo guardar los campos de contacto";
                    ...
                    //POSTULACION
                    error = "Error:No se pudo guardar los campos de postulacion";
                    Interfaz.Altacv_Items(RHMCUH_NROCUR, "01", rbtl_postulacion.SelectedItem.Value.ToString(), "");

                    //EXPERIENCIA
                    error = "Error:No se pudo guardar los campos de experiencia";
                    ...
                    //FORMACION ACADEMICA
                    error = "Error:No se pudo guardar los campos de Formacion Academica";
        ...
        catch (Exception ex)
        {
            ...
            FailureText2.Text = error + ":" + ex.Message;
        }
    }
