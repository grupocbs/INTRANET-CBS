<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SIS_MANUALES_SOFTLAND.aspx.cs"
    MasterPageFile="~/Site.master" Inherits="SIS_MANUALES_SOFTLAND" Culture="es-AR"
    UICulture="es-AR" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <dx:ASPxFormLayout runat="server" ID="formLayout" CssClass="formLayout" SettingsItems-HorizontalAlign="Center"
        ...
        <Items>
            <dx:LayoutGroup Caption="Manuales Softland" GroupBoxDecoration="HeadingLine" ColCount="1"
                UseDefaultPaddings="false" Paddings-PaddingTop="10">
                <GroupBoxStyle>
                    <Caption Font-Bold="true" Font-Size="14" />
                </GroupBoxStyle>
            </dx:LayoutGroup>
            <dx:LayoutGroup Caption="Archivos PDF Cargados" GroupBoxDecoration="box">
                <Items>
                        ...
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer>
                                <dx:ASPxFileManager ID="fileManager" runat="server" OnFolderCreating="fileManager_FolderCreating"
                                    ...
                                    <Settings RootFolder="~/Archivos/SIS/SOFTLAND/MANUALES" ThumbnailFolder="~/Content/FileManager/Thumbnails"
