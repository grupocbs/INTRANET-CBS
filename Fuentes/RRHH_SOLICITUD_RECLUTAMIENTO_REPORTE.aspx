<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RRHH_SOLICITUD_RECLUTAMIENTO_REPORTE.aspx.cs"
    MasterPageFile="~/Site.master" Inherits="RRHH_SOLICITUD_RECLUTAMIENTO_REPORTE"
        ...
        <ContentTemplate>
            <div>
                <dx:ASPxFormLayout runat="server" ID="formLayout" CssClass="formLayout" SettingsItems-HorizontalAlign="Center"
                    ...
                    <Items>
                        <dx:LayoutGroup Caption="Reclutamientos - Mis Solicitudes" GroupBoxDecoration="HeadingLine"
                        ...
                        <dx:LayoutGroup Caption="" GroupBoxDecoration="box">
                            <Items>
                                ...
                                <dx:LayoutItem Caption="Solicitudes de Reclutamiento" CaptionStyle-Font-Bold="true">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxComboBox ID="cmb_solicitudes" runat="server" Width="400px" EnableCallbackMode="true"
                        ...
                        <dx:LayoutGroup Caption="Descripcion del Puesto" GroupBoxDecoration="box">
                            <Items>
                                ...
                                <dx:LayoutItem Caption="Razon Social">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxComboBox ID="cmb_razon_social" runat="server" Width="300px" Enabled="false">
                                            </dx:ASPxComboBox>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
                                <dx:LayoutGroup Caption="Datos generales" GroupBoxDecoration="box">
                                    <Items>
                                        <dx:LayoutItem Caption="Nombre del Puesto">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxTextBox ID="txt_nombre_pesto" runat="server" Width="100%" Enabled="false">
                                                        <ValidationSettings EnableCustomValidation="True" ErrorDisplayMode="Text" ErrorTextPosition="Bottom"
                                                            SetFocusOnError="true">
                                                            <ErrorFrameStyle Font-Size="Smaller" />
                                                            <RequiredField IsRequired="True" ErrorText="Requerido" />
                                        ...
                                        <dx:LayoutItem Caption="Gerencia / Área a la que pertenece">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxTextBox ID="txt_area" runat="server" Width="100%" Enabled="false">
                                                        <ValidationSettings EnableCustomValidation="True" ErrorDisplayMode="Text" ErrorTextPosition="Bottom"
                                                            SetFocusOnError="true">
                                                            <ErrorFrameStyle Font-Size="Smaller" />
                                                            <RequiredField IsRequired="True" ErrorText="Requerido" />
                                            ...
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxComboBox ID="cmb_convenio" runat="server" Width="400px" EnableCallbackMode="true"
                                                        Enabled="false" IncrementalFilteringMode="StartsWith" OnSelectedIndexChanged="cmb_convenio_SelectedIndexChanged"
                                                        AutoPostBack="true">
                                                        <ValidationSettings EnableCustomValidation="True" ErrorDisplayMode="Text" ErrorTextPosition="Bottom"
                                                            SetFocusOnError="true">
                                                            <ErrorFrameStyle Font-Size="Smaller" />
                                            ...
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxComboBox ID="cmb_categorias" runat="server" Width="400px" EnableCallbackMode="true"
                                                        Enabled="false" IncrementalFilteringMode="StartsWith">
                                                        <ValidationSettings EnableCustomValidation="True" ErrorDisplayMode="Text" ErrorTextPosition="Bottom"
                                                            SetFocusOnError="true">
                                                            <ErrorFrameStyle Font-Size="Smaller" />
                                                            <RequiredField IsRequired="True" ErrorText="Requerido" />
                                            ...
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxComboBox ID="cmb_cliente" runat="server" Width="400px" EnableCallbackMode="true"
                                                        Enabled="false" AutoPostBack="true" IncrementalFilteringMode="StartsWith" OnSelectedIndexChanged="cmb_cliente_SelectedIndexChanged">
                                                    </dx:ASPxComboBox>
                                                </dx:LayoutItemNestedControlContainer>
                                            </LayoutItemNestedControlCollection>
                                        </dx:LayoutItem>
                                        ...
                                        <dx:LayoutItem Caption="Información sobre la vacante">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxRadioButtonList runat="server" ID="rbtl_tipo" Width="300px" Enabled="false">
                                                        <Items>
                                        ...
                                        <dx:LayoutItem Caption="La Vacante se produjo por">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxRadioButtonList runat="server" ID="rbtl_motivo" Width="300px" Enabled="false">
                                                        <Items>
                                ...
                                <dx:LayoutGroup Caption="Aspectos Organizativos" GroupBoxDecoration="box">
                                    <Items>
                                            ...
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxRadioButtonList runat="server" ID="rbtl_ded_esp" Width="300px" AutoPostBack="true"
                                                        OnSelectedIndexChanged="rbtl_ded_esp_SelectedIndexChanged" Enabled="false">
                                                        <Items>
                                        ...
                                        <dx:LayoutItem Caption="Cantidad de Horas">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxTextBox ID="txt_cant_hs" runat="server" Width="80px" Enabled="false">
                                                    </dx:ASPxTextBox>
                                                </dx:LayoutItemNestedControlContainer>
                                            </LayoutItemNestedControlCollection>
                                        </dx:LayoutItem>
                                                    ...
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td style="padding: 2px" valign="middle">
                                                                <dx:ASPxTextBox ID="txt_horario_de" runat="server" Width="120px" Enabled="false">
                                                                    <ValidationSettings EnableCustomValidation="True" ErrorDisplayMode="Text" ErrorTextPosition="Bottom"
                                                                        SetFocusOnError="true">
                                                                        <ErrorFrameStyle Font-Size="Smaller" />
                                                                        <RequiredField IsRequired="True" ErrorText="Requerido" />
                                                            ...
                                                            <td style="padding: 2px" valign="middle">
                                                                <dx:ASPxTextBox ID="txt_horario_hasta" runat="server" Width="120px" Enabled="false">
                                                                    <ValidationSettings EnableCustomValidation="True" ErrorDisplayMode="Text" ErrorTextPosition="Bottom"
                                                                        SetFocusOnError="true">
                                                                        <ErrorFrameStyle Font-Size="Smaller" />
                                                                        <RequiredField IsRequired="True" ErrorText="Requerido" />
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding: 2px" valign="middle">
                                                                <dx:ASPxTextBox ID="txt_horario_yde" runat="server" Width="120px" Enabled="false">
                                                                    <ValidationSettings EnableCustomValidation="True" ErrorDisplayMode="Text" ErrorTextPosition="Bottom"
                                                                        SetFocusOnError="true">
                                                                        <ErrorFrameStyle Font-Size="Smaller" />
                                                                        <RequiredField IsRequired="True" ErrorText="Requerido" />
                                                            ...
                                                            <td style="padding: 2px" valign="middle">
                                                                <dx:ASPxTextBox ID="txt_horario_yhasta" runat="server" Width="120px" Enabled="false">
                                                                    <ValidationSettings EnableCustomValidation="True" ErrorDisplayMode="Text" ErrorTextPosition="Bottom"
                                                                        SetFocusOnError="true">
                                                                        <ErrorFrameStyle Font-Size="Smaller" />
                                                                        <RequiredField IsRequired="True" ErrorText="Requerido" />
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding: 2px" valign="middle">
                                                                <dx:ASPxComboBox ID="cmb_dia_de" runat="server" Width="200px" EnableCallbackMode="true"
                                                                    IncrementalFilteringMode="StartsWith" Enabled="false">
                                                                    <Items>
                                        ...
                                        <dx:LayoutItem Caption="Turno de trabajo">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxRadioButtonList runat="server" ID="rbtl_turno_t" Width="300px" Enabled="false">
                                                        <Items>
                                            ...
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxRadioButtonList runat="server" ID="rbtl_deb_v" Width="300px" AutoPostBack="true"
                                                        Enabled="false" OnSelectedIndexChanged="rbtl_deb_v_SelectedIndexChanged">
                                                        <Items>
                                        ...
                                        <dx:LayoutItem Caption="Zonas">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxMemo ID="txt_zonas" runat="server" Width="100%" Height="80px" Enabled="false">
                                                    </dx:ASPxMemo>
                                                </dx:LayoutItemNestedControlContainer>
                                            </LayoutItemNestedControlCollection>
                                        </dx:LayoutItem>
                                            ...
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxRadioButtonList runat="server" ID="rbtl_deb_c" Width="300px" AutoPostBack="true"
                                                        Enabled="false" OnSelectedIndexChanged="rbtl_deb_c_SelectedIndexChanged">
                                                        <Items>
                                                            <dx:ListEditItem Selected="true" Value="No" Text="No" />
                                                            <dx:ListEditItem Text="Si" Value="Si" />
                                                        </Items>
                                            ...
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <table width="100%">
                                                        <tr>
                                                            <td>
                                                                <dx:ASPxLabel ID="ASPxLabel1" runat="server" ForeColor="Red" Font-Size="10" Text="Objetivo general del puesto: (Principal misión u objetivo del puesto. El resultado global que da sentido y razón de ser al puesto)">
                                                                </dx:ASPxLabel>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <dx:ASPxMemo ID="txt_objetivo" runat="server" Width="100%" Height="50px" Enabled="false">
                                                                    <ValidationSettings EnableCustomValidation="True" ErrorDisplayMode="Text" ErrorTextPosition="Bottom"
                                                                        SetFocusOnError="true">
                                                                        <ErrorFrameStyle Font-Size="Smaller" />
                                                                        <RequiredField IsRequired="True" ErrorText="Requerido" />
                                            ...
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <table width="100%">
                                                        <tr>
                                                            <td>
                                                                <dx:ASPxLabel ID="ASPxLabel3" runat="server" ForeColor="Red" Font-Size="10" Text="(Directas derivadas del puesto de trabajo)">
                                                                </dx:ASPxLabel>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <table width="100%">
                                                        <tr>
                                                            <td>
                                                                <dx:ASPxLabel ID="ASPxLabel2" runat="server" ForeColor="Red" Font-Size="10" Text="(A continuación detallar con precisión las competencias requeridas para el puesto)">
                                                                </dx:ASPxLabel>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <dx:ASPxMemo ID="txt_funciones" runat="server" Width="100%" Height="50px" Enabled="false">
                                                                    <ValidationSettings EnableCustomValidation="True" ErrorDisplayMode="Text" ErrorTextPosition="Bottom"
                                                                        SetFocusOnError="true">
                                                                        <ErrorFrameStyle Font-Size="Smaller" />
                                                                        <RequiredField IsRequired="True" ErrorText="Requerido" />
                                            ...
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <table width="100%">
                                                        <tr>
                                                            <td>
                                                                <dx:ASPxLabel ID="ASPxLabel4" runat="server" ForeColor="Red" Font-Size="10" Text="(Detallar con quién y cómo se relaciona (Jefe inmediato, contribuyentes, compañeros de trabajo, gente a su cargo, Otros) ">
                                                                </dx:ASPxLabel>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <dx:ASPxMemo ID="txt_relacion" runat="server" Width="100%" Height="50px" Enabled="false">
                                                                    <ValidationSettings EnableCustomValidation="True" ErrorDisplayMode="Text" ErrorTextPosition="Bottom"
                                                                        SetFocusOnError="true">
                                                                        <ErrorFrameStyle Font-Size="Smaller" />
                                                                        <RequiredField IsRequired="True" ErrorText="Requerido" />
                                ...
                                <dx:LayoutGroup Caption="Generales" GroupBoxDecoration="box">
                                    <Items>
                                        <dx:LayoutItem Caption="Edad Minima">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxTextBox ID="txt_edad_minima" runat="server" Width="50px" Enabled="false">
                                                        <ValidationSettings EnableCustomValidation="True" ErrorDisplayMode="Text" ErrorTextPosition="Bottom"
                                                            SetFocusOnError="true">
                                                            <ErrorFrameStyle Font-Size="Smaller" />
                                                            <RequiredField IsRequired="True" ErrorText="Requerido" />
                                        ...
                                        <dx:LayoutItem Caption="Edad MAxima">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxTextBox ID="txt_edad_maxima" runat="server" Width="50px" Enabled="false">
                                                        <ValidationSettings EnableCustomValidation="True" ErrorDisplayMode="Text" ErrorTextPosition="Bottom"
                                                            SetFocusOnError="true">
                                                            <ErrorFrameStyle Font-Size="Smaller" />
                                                            <RequiredField IsRequired="True" ErrorText="Requerido" />
                                        ...
                                        <dx:LayoutItem Caption="Genero preferido">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxRadioButtonList runat="server" ID="rbtl_genero" Width="300px" Enabled="false">
                                                        <Items>
                                ...
                                <dx:LayoutGroup Caption="Formación" GroupBoxDecoration="box">
                                    <Items>
                                            ...
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <table>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <dx:ASPxRadioButtonList runat="server" ID="rbtl_formacion" Width="300px" Enabled="false">
                                                                    <Items>
                                            ...
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxRadioButtonList runat="server" ID="rbtl_formacion_estado" Width="300px" AutoPostBack="true"
                                                        Enabled="false" OnSelectedIndexChanged="rbtl_formacion_estado_SelectedIndexChanged">
                                                        <Items>
                                        ...
                                        <dx:LayoutItem Caption="Titulo">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxTextBox ID="txt_titulo" runat="server" Width="100%" Enabled="false">
                                                    </dx:ASPxTextBox>
                                                </dx:LayoutItemNestedControlContainer>
                                            </LayoutItemNestedControlCollection>
                                        </dx:LayoutItem>
                                ...
                                <dx:LayoutGroup Caption="Experiencia" GroupBoxDecoration="box">
                                    <Items>
                                            ...
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <dx:ASPxLabel ID="ASPxLabel15" runat="server" ForeColor="Red" Font-Size="10" Text="Tanto específica como de otros puestos de trabajo. Se trata de aprendizajes adquiridos por la práctica profesional y no por el tiempo transcurrido, que garantizan la resolución de situaciones especiales que pueden presentarse en el ejercicio del puesto">
                                                                </dx:ASPxLabel>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <dx:ASPxMemo ID="txt_experiencia" runat="server" Width="100%" Height="50px" Enabled="false">
                                                                    <ValidationSettings EnableCustomValidation="True" ErrorDisplayMode="Text" ErrorTextPosition="Bottom"
                                                                        SetFocusOnError="true">
                                                                        <ErrorFrameStyle Font-Size="Smaller" />
                                                                        <RequiredField IsRequired="True" ErrorText="Requerido" />
                                        ...
                                        <dx:LayoutItem Caption="Tiempo">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxRadioButtonList runat="server" ID="rbtl_experiencia" Width="300px" Enabled="false">
                                                        <Items>
