...
using System.Text.RegularExpressions;
    ...
    public class FTPclient
    {
        ...
        public List<string> ListDirectory(string directory)
        {
            ...
            {
                throw new Exception(ex.Message + " - ListDirectory()");
            }
        ...
        public FTPdirectory ListDirectoryDetail(string directory)
        {
            ...
            {
                throw new Exception(ex.Message + " - ListDirectoryDetail()");
            }
        }
        ...
        public bool Upload(string localFilename, string targetFilename)
        {
            ...
            {
                throw new Exception(ex.Message + " - Upload()");
            }
        }
        ...
        public bool Download(string sourceFilename, string localFilename, bool PermitOverwrite)
        {
            ...
            {
                throw new Exception(ex.Message + " - Download()");
            }
        }
        ...
        public bool FtpDelete(string filename)
        {
            ...
            {
                throw new Exception(ex.Message + " - FtpDelete()");
            }
        }
        ...
        public bool FtpFileExists(string filename)
        {
            ...
            {
                throw new Exception(ex.Message + " - FtpFileExists()");
            }
        }
        ...
        public long GetFileSize(string filename)
        {
            ...
            {
                throw new Exception(ex.Message + " - GetFileSize()");
            }
        }
        ...
        public bool FtpRename(string sourceFilename, string newName)
        {
            ...
            {
                throw new Exception(ex.Message + " - FtpRename()");
            }
        }
        ...
        public bool FtpCreateDirectory(string dirpath)
        {
            ...
            {
                throw new Exception(ex.Message + " - FtpCreateDirectory()");
            }
        }
        ...
        public bool FtpDeleteDirectory(string dirpath)
        {
            ...
            {
                throw new Exception(ex.Message + " - FtpDeleteDirectory()");
            }
        }
        #endregion
        ...
        private FtpWebRequest GetRequest(string URI)
        {
            ...
            {
                throw new Exception(ex.Message + " - GetRequest()");
            }
        }
        ...
        private System.Net.ICredentials GetCredentials()
        {
            ...
            {
                throw new Exception(ex.Message + " - GetCredentials()");
            }
        }
        ...
        private string GetFullPath(string file)
        {
            ...
            {
                throw new Exception(ex.Message + " - GetFullPath()");
            }
        }
        ...
        private string GetDirectory(string directory)
        {
            ...
            {
                throw new Exception(ex.Message + " - GetDirectory()");
            }
        }
        ...
        private string GetStringResponse(FtpWebRequest ftp)
        {
            ...
            {
                throw new Exception(ex.Message + " - GetStringResponse()");
            }
        }
        ...
        private long GetSize(FtpWebRequest ftp)
        {
            ...
            {
                throw new Exception(ex.Message + " - GetSize()");
            }
        }
        #endregion
	...
	public class FTPfileInfo
	{
		...
		public FTPfileInfo(string line, string path)
		{
            ...
            {
                throw new Exception(ex.Message + " - FTPfileInfo()");
            }
		}
		...
		private Match GetMatchingRegex(string line)
		{
            ...
            {
                throw new Exception(ex.Message + " - GetMatchingRegex()");
            }
		}
	...
	public class FTPdirectory : List<FTPfileInfo>
	{
		...
		public FTPdirectory(string dir, string path)
		{
            ...
            {
                throw new Exception(ex.Message + " - FTPdirectory()");
            }
		}
		...
		public FTPdirectory GetFiles(string ext)
		{
            ...
            {
                throw new Exception(ex.Message + " - GetFiles()");
            }
		}
		...
		public FTPdirectory GetDirectories()
		{
            ...
            {
                throw new Exception(ex.Message + " - GetDirectories()");
            }
		}
		...
		private FTPdirectory GetFileOrDir(FTPfileInfo.DirectoryEntryTypes type, string ext)
		{
            ...
            {
                throw new Exception(ex.Message + " - GetFileOrDir()");
            }
		...
		public bool FileExists(string filename)
		{
            ...
            {
                throw new Exception(ex.Message + " - FileExists()");
            }
		}
		...
		public static string GetParentDirectory(string dir)
		{
            ...
            {
                throw new Exception(ex.Message + " - GetParentDirectory()");
            }
		}
	}
	#endregion
