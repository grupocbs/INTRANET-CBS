...
public partial class RRHH_NORMATIVAS_VER: System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["TIPO"]!=null)
            {
                ...
                FailureText.Text = "NORMATIVAS DE " + tipo;
                if (Directory.Exists(Server.MapPath(UploadDirectory + "/" + tipo)))
                {
                    fileManager.Settings.RootFolder = Server.MapPath(UploadDirectory + "/" + tipo);
                }
            }
        }
